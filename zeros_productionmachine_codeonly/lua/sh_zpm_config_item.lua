...
ZPM_ITEM_APPLEPIE = AddItem({
	...
	// Adds support for the darkrp hungermod
	hunger = {
		// How much health will the player get when eating this item
		// NOTE If not set then he will not get any health from eating this item
		health = 10,

		// The player cant gain more then this amount
		health_cap = 100,

		// How much energy will the player get when eating this item
		// NOTE If not set then he will not get any energy from eating this item
		energy = 10,
	},
